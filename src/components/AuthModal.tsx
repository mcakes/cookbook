      ...
      <div className="bg-paper rounded-md border border-line shadow-lg p-6 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          <input
            ...
            placeholder="ghp_…"
            className="w-full bg-field border border-line rounded px-3 py-2 mb-4 font-mono text-sm text-ink placeholder:text-muted focus:border-accent transition-colors"
            autoFocus
          />
